...
def pre_processing_v2():
    try:
        ...
        # Kiểm tra nếu tất cả các cột liên tục đều tồn tại
        missing_columns = [col for col in continuous_columns if col not in res_df.columns]
...
def pre_processing_maxmin():
    try:
        ...
        print("Dữ liệu sau khi xử lý:", processed_record)
